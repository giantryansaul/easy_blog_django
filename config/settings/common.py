# -*- coding: utf-8 -*-
"""
Django settings for easy_blog_django project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'easy_blog_django.contrib.sites.migrations'
}
...
ADMINS = (
    ("""Ryan Saul""", 'giantryansaul@gmail.com'),
)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                ...
                "easy_blog_django.context_processors.allauth",
            ],
        },
    },
]
...
STATIC_ROOT = environ.Path(ROOT_DIR, 'staticfiles')
